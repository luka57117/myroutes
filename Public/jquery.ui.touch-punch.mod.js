...
(function ($) {
  ...
  function simulateMouseEvent (event, simulatedType) {
    ...
    if ($(touch.target).is("input") || $(touch.target).is("textarea") || ($(touch.target).attr("contentEditable") == "true")) {   
  ...
  mouseProto._touchStart = function (event) {
    ...
    // Ignore the event on div.contentEditable
    var touch = event.originalEvent.changedTouches[0];
    if($(touch.target).attr("contentEditable") == "true") {
      return;
    }
